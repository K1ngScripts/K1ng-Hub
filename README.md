...
local Window = OrionLib:MakeWindow({Name = "K1ng Script", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "K1ng Script"})
...
W:AddLabel("[+] K1ng Script is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "K1ng Script(Noitification)",
